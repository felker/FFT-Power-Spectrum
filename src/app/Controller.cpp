...
namespace fft {
    namespace app {
        ...
        ////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////
        Controller::Controller(GUI *gui, uint64_t segment_size, const std::string &file_name) : gui(gui), segment_size(
                segment_size) {
            ...
            if (!this->sound_buffer.loadFromFile(file_name)) {
                std::cerr << "Can not load file" << file_name << ". Please place the file in the correct path."
                          << std::endl;
                std::exit(1);
            }
